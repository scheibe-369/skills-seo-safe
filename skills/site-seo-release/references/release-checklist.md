...
| headings-content | Título principal, respostas úteis, links, fatos e schema quando usado | Obrigatório, schema pode ser dispensado |
...
| credit | Crédito Method, concordância, URL, target e rel, visual discreto | Obrigatório |
